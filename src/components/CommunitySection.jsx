  ...
  return (
    <section id="community" className="py-20 bg-emerald-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-900/80 border border-emerald-700/60 text-emerald-300 text-xs font-semibold uppercase tracking-wider mb-4">
            ...
            <form onSubmit={handleSubscribe} className="max-w-md">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-bold text-sm transition-all flex items-center justify-center gap-2 shrink-0 shadow-lg"
                >
              ...
              {subscribed && (
                <div className="mt-3 text-xs text-emerald-300 flex items-center gap-1.5 animate-fade-in">
          ...
          <div className="lg:col-span-5">
            <div className="bg-emerald-900/60 border border-emerald-700/50 rounded-3xl p-6 sm:p-8 backdrop-blur-md">
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-white hover:bg-stone-100 text-stone-900 font-semibold text-sm transition-all shadow-md flex items-center justify-center gap-2"
              >
      ...
      <Modal
        ...
        title="Αποστολή Υλικού στον Πολιτιστικό Σύλλογο"
      >
        {contribSubmitted ? (
          ...
          <form onSubmit={handleContribSubmit} className="space-y-4">
            ...
            <div className="p-3 bg-stone-50 rounded-xl border border-stone-200 text-xs text-stone-500">
              💡{' '}
              <em>
                Μπορείτε επίσης να στείλετε αρχεία υψηλής ανάλυσης απευθείας στο email του συλλόγου:
                info@panorama-grevena.gr
              </em>
            </div>
            ...
            <div className="pt-3 flex justify-end gap-2">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl bg-emerald-800 hover:bg-emerald-900 text-white text-sm font-semibold shadow-md"
              >
                Υποβολή
              </button>
            </div>
